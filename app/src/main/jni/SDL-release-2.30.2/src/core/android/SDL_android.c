...
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(
    ...
    jbyteArray romData, jint romSize, jint params, jlongArray codesArray);
...
static JNINativeMethod SDLActivity_tab[] = {
    ...
    { "nativeRunMain", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;[BII[J)I", SDL_JAVA_INTERFACE(nativeRunMain) },
...
/* MasterEmu start_emulator function prototype */
typedef int (*start_emulator_func)(JNIEnv *env, jclass cls, jobject obj, jbyteArray romData, jint romSize, jint params, jlongArray codesArray);

/* Start up the SDL app */
JNIEXPORT int JNICALL SDL_JAVA_INTERFACE(nativeRunMain)(JNIEnv *env, jclass cls, jstring library, jstring function, jobject array, jbyteArray romData, jint romSize, jint params, jlongArray codesArray)
{
    int status = -1;
    ...
    if (library_handle) {
        ...
        start_emulator_func start_emulator;

        function_name = (*env)->GetStringUTFChars(env, function, NULL);
        /*SDL_main = (SDL_main_func)dlsym(library_handle, function_name);
        if (SDL_main) {*/
        start_emulator = (start_emulator_func)dlsym(library_handle, "start_emulator");
        if (start_emulator) {
            int i;
            int argc;
            int len;
            ...
            status = start_emulator(env, cls, obj, romData, romSize, params, codesArray);
