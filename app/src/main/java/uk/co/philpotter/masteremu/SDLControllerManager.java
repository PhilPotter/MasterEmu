    ...
    public boolean handleMotionEvent(MotionEvent event) {
        ...
        if (event.getActionMasked() == MotionEvent.ACTION_MOVE) {
            ...
            if ((event.getSource() & InputDevice.SOURCE_DPAD) == InputDevice.SOURCE_DPAD) {
                ...
                if (x == 0) {
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_LEFT);
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_RIGHT);
                } else if (x == -1.0f) {
                    SDLActivity.onMasterEmuDown(KeyEvent.KEYCODE_DPAD_LEFT);
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_RIGHT);
                } else if (x == 1.0f) {
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_LEFT);
                    SDLActivity.onMasterEmuDown(KeyEvent.KEYCODE_DPAD_RIGHT);
                }

                if (y == 0) {
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_UP);
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_DOWN);
                } else if (y == -1.0f) {
                    SDLActivity.onMasterEmuDown(KeyEvent.KEYCODE_DPAD_UP);
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_DOWN);
                } else if (y == 1.0f) {
                    SDLActivity.onMasterEmuUp(KeyEvent.KEYCODE_DPAD_UP);
                    SDLActivity.onMasterEmuDown(KeyEvent.KEYCODE_DPAD_DOWN);
                }
            } else if ((event.getSource() & InputDevice.SOURCE_JOYSTICK) == InputDevice.SOURCE_JOYSTICK) {
                InputDevice.MotionRange xRange = dev.getMotionRange(MotionEvent.AXIS_X);
                InputDevice.MotionRange yRange = dev.getMotionRange(MotionEvent.AXIS_Y);
                float xHat = event.getAxisValue(MotionEvent.AXIS_HAT_X);
                ...
                if (xRange == null || yRange == null)
                    ...
                    if (Math.abs(xVal) <= xRange.getMax() / 2)
                        xVal = 0;
