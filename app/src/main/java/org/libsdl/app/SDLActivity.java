...
import uk.co.philpotter.masteremu.RomData;
...
*/
    ...
    /**
     * This method is called from the native side, and allows us to calculate
     * a sensible button size in a resolution independent way.
     */
    public int getPixelsForOneInch() {
    ...
    // This can be run from native code to instantiate the pause menu
    public void loadPauseMenu(long EmulatorContainerPointer, String checksum) {
        int lowerAddress = (int) EmulatorContainerPointer;
        int higherAddress = (int) (EmulatorContainerPointer >> 32);
        Bundle b = new Bundle();
        b.putInt("lowerAddress", lowerAddress);
        b.putInt("higherAddress", higherAddress);
        b.putString("CHECKSUM", checksum);
        Intent pauseIntent = new Intent(SDLActivity.this, PauseActivity.class);
        pauseIntent.putExtra("MAIN_BUNDLE", b);
    ...
    public static native int nativeRunMain(String library, String function, Object arguments, byte[] romData, int romSize, int params, long[] codesArray);
    ...
    public static native void onMasterEmuDown(int keycode);
    public static native void onMasterEmuUp(int keycode);
